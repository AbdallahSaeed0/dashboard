        ...
        <div class="card-body pt-3">
          ...
          <div class="tab-content pt-2">
                  ...
                  <div class="col-md-8 col-lg-9">
                    ...
                    <div class="pt-2">
                     ...
                     <span id="image_name"></span>
                      <input type="file" name="image" class="d-none" id="image_upload">
                    </div>
                  </div>
                </div>
            ...
            <div class="tab-pane fade pt-3" id="profile-change-password">
              ...
              <form action="<?= url("/controller/profile.php")?>" method="post">
...
let image = document.querySelector("#image_upload");
let span = document.querySelector("#image_name");
image.addEventListener("change", function(){
span.innerHTML= image.files[0].name
})
